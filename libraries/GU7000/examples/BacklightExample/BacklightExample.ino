...
void setup() {
  ...
  vfd.print("Noritake");
  //Uncomment the color of your choice
  //vfd.GU7000_setBacklightColor(255, 0, 0); // for red
  vfd.GU7000_setBacklightColor(0, 255, 0); // for green
  //vfd.GU7000_setBacklightColor(0, 0, 255); // for blue
}
